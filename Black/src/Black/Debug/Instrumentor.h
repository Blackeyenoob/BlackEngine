...
#define BK_PROFILE 0
	...
	#define BK_PROFILE_BEGIN_SESSION(name, filepath) ::Black::Instrumentor::Get().BeginSession(name, filepath)
	#define BK_PROFILE_END_SESSION() ::Black::Instrumentor::Get().EndSession()
	#define BK_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Black::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Black::InstrumentationTimer timer##line(fixedName##line.Data)
